...
public class VentanaLogin {
	...
	private void initialize() {
		...
		JLabel lblNewJgoodiesTitle = DefaultComponentFactory.getInstance().createTitle("ADIVINA LA PELICULA");
		lblNewJgoodiesTitle.setFont(new Font("Arial", Font.PLAIN, 24));
		...
		frmPruebaVentana.getContentPane().setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{txtNombre, tpNombre, passwordField, tpPasswordField, btnNewButton}));
